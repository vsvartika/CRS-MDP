...
rew_obt =[    0.5588    0.3432    0.2920    0.2483    0.2214    0.2368   ];


cost_obt =[    0.6000    0.6000    0.6000    0.6000    0.6000    0.6000   ];


x_arr =[    0.1000    3.1000    6.1000    9.1000   12.1000   15.1000  ];

figure(1)
plot(x_arr,rew_obt,'b--*', 'LineWidth',1.5, 'MarkerSize',10)
hold on
plot(x_arr,cost_obt,'r--o','LineWidth',1.5,'MarkerSize',10)
legend('Optimal Reward','Cost')
xlabel('Risk factor \gamma')
xlim([0.1,15.1]);
ylim([0,0.8])
hold off
